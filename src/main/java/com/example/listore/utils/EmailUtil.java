...
public class EmailUtil {
    ...
    public static String getUserRegisterTemplate(String token, String code) {
        return "<h3>Completa tu registro en el siguiente <a href=\"https://indupest-front-deploy.vercel.app/passwordChange?token="+token+"\"> enlace</a></h3> <h3>Tu código es: " + code + "</h3>";
    }
    ...
    public static String getUserRecoveryTemplate(String token, String code) {
        return "<h3>Recupera tu contraseña en el siguiente <a href=\"http://localhost:4200/passwordChange?token="+token+"\"> enlace</a></h3> <h3>Tu código es: " + code + "</h3>";
    }
